...
if (small_areas){
  data_raw <- read.csv("C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/census_data/AllThemesTablesSA.csv")  
  ireland_map <- readShapePoly('C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/boundary_files/Census2011_Small_Areas_generalised20m.shp')
  ...
  data_raw <- read.csv("C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/census_data/AllThemesTablesED.csv")  
  names(data_raw)[1] <- "GEOGID" 
  ireland_map <- readShapePoly('C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/boundary_files/Census2011_Electoral_Divisions_generalised20m.shp')
...
if (filter){
  counties <- c("Fingal", "Dublin City", "South Dublin", "Dublin Laoghaire-Rathdown")
...
source("C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/convertCSOdata.R")
...
source('C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/coolBlueHotRed.R')
...
source('C:/Users/user/Dropbox/수업자료/대학/(4)Senior/4-2/통계적방법론(1전공)/Mid-term Assignment/2014_01_SOM_Example_code_release/plotHeatMap.R')
...
#+ geom_path(colour="white", alpha=0.5, size=0.2) 
